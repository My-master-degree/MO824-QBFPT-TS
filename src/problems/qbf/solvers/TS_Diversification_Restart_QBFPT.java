 ...
 */
public class TS_Diversification_Restart_QBFPT extends AbstractTS<Integer> {		
	 ...
	 */
	public TS_Diversification_Restart_QBFPT(Integer tenure, Integer iterations, String filename) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		TS_Diversification_Restart_QBFPT tabusearch = new TS_Diversification_Restart_QBFPT(20, 10000, "instances/qbf100");
